...
const EnterpriseFlow = ({ category }) => {
  return (
    <div className="grid lg:grid-cols-[1fr_380px] gap-8">
      {/* LEFT SIDE */}
      <div>
        {/* STEPPER */}
        <div className="flex items-center gap-4 mb-10 overflow-x-auto pb-4 hide-scroll">
          {category.flowSteps.map((step, idx) => (
              ...
              <div className="flex items-center gap-4 shrink-0">
                <div className="flex items-center gap-3">
                  <div
                    ...
                    style={{
                      background: idx === 0 ? category.accent : "",
                    }}
                  >
                    {idx === 0 ? <Check size={20} /> : idx + 1}
                  </div>
                  <div>
                    <p className="text-xs uppercase tracking-[0.2em] text-white/40 mb-1">
                      Step {idx + 1}
                    </p>
                    <h3 className="text-white/80 font-medium">{step.title}</h3>
                  </div>
                </div>
              </div>

              {/* Line */}
              {idx !== category.flowSteps.length - 1 && (
        ...
        <div className="rounded-[40px] border border-white/10 bg-[#0D172A]/80 backdrop-blur-2xl p-8 lg:p-10 shadow-[0_20px_100px_rgba(0,0,0,0.35)]">
          ...
          <div className="mb-10">
            ...
            <p className="text-white/60 text-lg leading-relaxed">
              Schedule enterprise inventory evaluation for office assets, 
              workstations, bulk electronics and commercial liquidation.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-5 mb-8">
            ...
            <div className="rounded-3xl border border-white/10 bg-white/[0.03] p-6">
              <div className="flex items-center gap-3 mb-5">
                ...
                >
                  <Building2 size={24} style={{ color: category.accent }} />
                </div>
                <div>
                  <p className="text-white/40 text-sm mb-1">Company Name</p>
                  <h3 className="text-white text-lg">Business Information</h3>
                </div>
              </div>
              <input
                type="text"
            ...
            <div className="rounded-3xl border border-white/10 bg-white/[0.03] p-6">
              <div className="flex items-center gap-3 mb-5">
                <div
                  ...
                  style={{ background: `${category.accent}20` }}
                >
                  <BriefcaseBusiness size={24} style={{ color: category.accent }} />
                </div>
                <div>
                  <p className="text-white/40 text-sm mb-1">Contact Person</p>
                  <h3 className="text-white text-lg">Enterprise Coordinator</h3>
                </div>
              </div>
              <input
                type="text"
          ...
          <div className="rounded-[32px] border border-white/10 bg-white/[0.03] p-8">
            <div className="flex items-center gap-4 mb-6">
              <div
                ...
                style={{ background: `${category.accent}20` }}
              >
                <FileSpreadsheet size={34} style={{ color: category.accent }} />
              </div>
              <div>
                ...
                <p className="text-white/50 leading-relaxed">
                  Upload Excel, CSV or inventory documents for bulk asset evaluation.
                </p>
              </div>
            </div>
            ...
            <label className="group relative flex flex-col items-center justify-center rounded-[28px] border-2 border-dashed border-white/10 bg-white/[0.03] hover:bg-white/[0.05] transition-all duration-300 p-12 cursor-pointer overflow-hidden">
              <div
                className="absolute inset-0 opacity-0 group-hover:opacity-20 transition-all"
                style={{
              ...
              <div
                ...
                style={{ background: `${category.accent}20` }}
              >
                <Upload size={38} style={{ color: category.accent }} />
              </div>
              ...
              <p className="relative z-10 text-white/50 text-center max-w-md leading-relaxed">
                Drag & drop Excel sheets, inventory exports or asset lists
              </p>
            </label>
          </div>
        </div>
      ...
      <div>
        <div className="sticky top-28 rounded-[36px] border border-white/10 bg-[#0D172A]/90 backdrop-blur-2xl overflow-hidden shadow-[0_20px_100px_rgba(0,0,0,0.35)]">
          <div className="relative h-[260px] overflow-hidden">
            ...
            />
            <div className="absolute inset-0 bg-gradient-to-t from-[#040B1A] via-black/30 to-transparent" />
          </div>
          ...
          <div className="p-8">
            ...
            <p className="text-white/60 leading-relaxed mb-8">
              Dedicated enterprise handling for office liquidation, IT assets 
              and commercial inventory management.
            </p>

            <button
              className="w-full h-14 rounded-2xl flex items-center justify-center gap-3 font-semibold text-lg hover:scale-[1.02] transition-all"
